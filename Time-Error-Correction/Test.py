...
startTime = 0
endTime = 1.6
Experiment.choose_methods(system="L63+time", integration="RK4", assimilation="RHF")
...
ensembleList, ensembleTimeList = Experiment.run_ensemble(startTime, endTime, 0.01, 120, error, error, obsList[0], [True, True, True, False], [2.5, 2.5, 2.5, 0])
print("Ensemble Run")
